...
namespace X2 {
	...
	void VulkanSwapChain::InitSurface(GLFWwindow* windowHandle)
	{
		...
		X2_CORE_ASSERT(graphicsQueueNodeIndex != UINT32_MAX);
		X2_CORE_ASSERT(presentQueueNodeIndex != UINT32_MAX);
	...
	void VulkanSwapChain::Create(uint32_t* width, uint32_t* height, bool vsync)
	{
		...
		X2_CORE_ASSERT(presentModeCount > 0);
	...
	{
		X2_CORE_WARN_TAG("Renderer", "VulkanSwapChain::OnDestroy");
	...
	{
		X2_CORE_WARN_TAG("Renderer", "VulkanSwapChain::OnResize");
	...
	{
		X2_SCOPE_PERF("VulkanSwapChain::BeginFrame");
	...
	{
		//X2_PROFILE_FUNC();
		X2_SCOPE_PERF("VulkanSwapChain::Present");
		...
		VkResult result;
		{
			X2_SCOPE_PERF("VulkanSwapChain::Present - QueuePresent");
		...
		{
			//X2_PROFILE_FUNC("VulkanSwapChain::Present - WaitForFences");
