...
namespace X2::Utils {
	...
	static constexpr std::string_view RemoveNamespace(std::string_view name)
	{
	...
	static constexpr std::string_view RemoveOuterNamespace(std::string_view name)
	{
	...
	template<size_t N>
	static constexpr std::array<std::string_view, N>& RemoveNamespace(std::array<std::string_view, N>& memberList)
	{
