...
namespace X2::UI {
	...
	void DrawShadow(const Ref<VulkanTexture2D>& shadowImage, int radius, ImVec2 rectMin, ImVec2 rectMax, float alphMultiplier, float lengthStretch,
	...
	void DrawShadow(const Ref<VulkanTexture2D>& shadowImage, int radius, ImRect rectangle, float alphMultiplier, float lengthStretch,
		bool drawLeft, bool drawRight, bool drawTop, bool drawBottom)
	{
	...
	void DrawShadow(const Ref<VulkanTexture2D>& shadowImage, int radius, float alphMultiplier, float lengthStretch,
		bool drawLeft, bool drawRight, bool drawTop, bool drawBottom)
	{
	...
	void DrawShadowInner(const Ref<VulkanTexture2D>& shadowImage, int radius, ImVec2 rectMin, ImVec2 rectMax, float alpha, float lengthStretch,
		bool drawLeft, bool drawRight, bool drawTop, bool drawBottom)
	{
		const float widthOffset = lengthStretch;
	...
	void DrawShadowInner(const Ref<VulkanTexture2D>& shadowImage, int radius, ImRect rectangle, float alpha, float lengthStretch,
		bool drawLeft, bool drawRight, bool drawTop, bool drawBottom)
	{
	...
	void DrawShadowInner(const Ref<VulkanTexture2D>& shadowImage, int radius, float alpha, float lengthStretch,
		bool drawLeft, bool drawRight, bool drawTop, bool drawBottom)
	{
