...
#include "X2/Editor/EditorConsolePanel.h"
#include "X2/Editor/ECSDebugPanel.h"

#include "X2/Editor/PanelManager.h"

#include "X2/Project/UserPreferences.h"
...
namespace X2 {
	...
	private:
		...
		struct CreateNewMeshPopupData
		{
			...
			std::array<char, 256> CreateSkeletonFilenameBuffer;
			std::array<char, 256> CreateAnimationFilenameBuffer;
			Entity TargetEntity;
		...
		std::future<void> m_AssetPackFuture;
