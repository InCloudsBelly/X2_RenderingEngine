...
#define ENABLED_GTAO (__X2_AO_METHOD & X2_AO_METHOD_GTAO)
#define ENABLED_HBAO (__X2_AO_METHOD & X2_AO_METHOD_HBAO)

#if ENABLED_GTAO
layout(binding = 0) uniform usampler2D u_GTAOTex;
#endif
...
void main()
{
    ...
    #endif
        occlusion = min(ao * GTAO_OCCLUSION_TERM_SCALE, 1.0f);
#endif
#if ENABLED_HBAO
